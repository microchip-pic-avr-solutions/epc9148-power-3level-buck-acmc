...
;  Author:      Yuanzhe
;  Date/Time:   11/4/2019 3:45:56 PM
; **********************************************************************************
;  1P1Z Control Library File (Single Bitshift-Scaling Mode)
; **********************************************************************************
...
;------------------------------------------------------------------------------
	...
	.global _pi_vcfly_Update
_pi_vcfly_Update:    ; provide global scope to routine
...
;------------------------------------------------------------------------------
; Compute compensation filter term
	clr a, [w8], w4, [w10], w6    ; clear accumulator A and prefetch first operands
	mac w4*w6, a    ; multiply & accumulate last control output with coefficient of the delay line (no more prefetch)	
